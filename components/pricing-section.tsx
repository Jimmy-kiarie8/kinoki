...
const packages = [
  {
    ...
    price: 2000,
    savings: 2000,
    description: "Grab two Kinoki packs for the price of one and feel lighter after the very first night.",
    features: ["2 packs • 20 pads total", "Stick before bed, peel in the morning", "Free nationwide delivery"],
    popular: false,
    image: "/images/1.jpeg",
  },
  {
    ...
    price: 3600,
    savings: 3600,
    description: "3-week detox makeover – stock up with four packs and pay for just two.",
    features: ["4 packs • 40 pads total", "Perfect for couples", "Cash on delivery available"],
    popular: true,
    image: "/images/2.jpeg",
  },
  {
    ...
    price: 5100,
    savings: 6900,
    description: "Family-sized Kinoki detox – six full packs for endless clean, happy feet.",
    features: ["6 packs • 60 pads total", "Extra adhesive sheets included", "Great for big households"],
    popular: false,
    image: "/images/3.jpeg",
  },
]
