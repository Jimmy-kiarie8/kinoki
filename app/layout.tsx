  ...
  return (
    <html lang="en">
      <head>
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-WSBMR2QQ');
          `}
        </Script>
        ...
        <noscript>
          <img 
            ...
            width="1" 
            style={{display: 'none'}}
            src="https://www.facebook.com/tr?id=712272431428331&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* End Meta Pixel Code */}
      ...
      <body>
        ...
        <noscript>
          <iframe 
            src="https://www.googletagmanager.com/ns.html?id=GTM-WSBMR2QQ"
            height="0" 
            width="0" 
